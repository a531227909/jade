...
public class SignUtils {
	 ...
	 * @return
	 */
	public static String build32Key() {
	...
	public static boolean checkParam(Map<String, String> params, String key) {
		...
		if (params.containsKey("sign")) {
			...
			String signRecieve = buildSign(params, key);
	 ...
	 * @return
	 */
	public static String buildSign(Map<String, String> reqMap, String secretKey) {
		Map<String, String> params = SignUtils.paraFilter(reqMap);
		StringBuilder buf = new StringBuilder((params.size() + 1) * 10);
		SignUtils.buildPayParams(buf, params, false);
		String preStr = buf.toString();
//		System.out.print("签名原串="+preStr+ "&key=" + secretKey);
		String sign = MD5.sign(preStr, "&key=" + secretKey, "utf-8");
